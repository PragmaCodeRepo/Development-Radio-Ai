...
urlpatterns = [
    ...
    path('intro-text-weather/',
         login_required(views.enter_intro_weather), name='enter_intro_weather',),
    path('outro-text-weather/',
         login_required(views.enter_outro_weather), name='enter_outro_weather',),
    ...
    path('azuracast/', views.azuracast, name='azuracast'),
